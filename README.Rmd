...
tibble::tibble(
  script = CursoRopen:::list_github_files(params$turma, nome_pasta, ".html"),
  link = paste0(
  ...
  trabalho = glue::glue("[{script}]({link})")
) |> 
...
```{r}
CursoRopen:::list_github_files(params$main_repo, "slides/", "[0-9]-.*html$") |>
...
knitr::kable(
  tibble::tibble(
   script = list.dirs(pasta, recursive = FALSE, full.names = TRUE),
    link = paste0(
